...
r.d = 10.^unifrnd(log10(3.68e-5)-dist,log10(3.68e-5)+dist,n,1);
...
% end
% save(strcat('r_2_',num2str(n)),'r')
% save(strcat('S_K_2_',num2str(n)),'Sim_K')
% save(strcat('S_I_2_',num2str(n)),'Sim_I')
% save(strcat('S_PC_2_',num2str(n)),'Sim_PC')
% % ================================= %
...
hold on
scatter(log10(r.yA1),log10(r.yA2),5,log10(Ratio_K),'filled','markerfacealpha',0.6)
hold on
% x = log10(r.yA1);
% y =log10(r.yA2);
% z = log10(Ratio_K);
...
% lines = [m_Exp_log_RT_K+thresh,m_Exp_log_RT_K-thresh];
...
% % leakage
% leakages = [-1.5,1;-0.2,-0.2;1,-1.5;1,1;-1.5,-1.5];
% 
% blue1 = [0 0 0.7];
% green1 = [0 0.7 0];
% c_pc = [0.7 0.7 0.7];
...
%     I
%     figure(1)
%     plot(leakages(I,1),leakages(I,2),'r.','markersize',15)
%     
% %     figure(2)
...
% thresh = 0.3;
thresh_K = 2*s_Exp_log_RT_K;
thresh_I = 2*s_Exp_log_RT_I;
